...
namespace LiquidTransform.functionapp.v1
{
    public static class JsonToXml
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = "jsontransformer/{liquidtransformfilename}")] HttpRequestMessage req,
